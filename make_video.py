...
def main():
    filename = "sim_000000927.csv"  # name of state matrix to load
    area = "arahama"
    foldername = "state_ql_mod_30_7_1000"  # folder where state matrices are saved
    timeSimulation = 30  # total time of simulation in minutes
